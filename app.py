            ...
            try:
                ...
                for i, col in enumerate(cols):
                    with col:
                        ...
                        st.image(plan_response, caption=f"PLAN OPTION {i + 1:02d}", use_column_width=True)
                ...
                try:
                    ...
                    for i, col in enumerate(cols):
                        with col:
                            ...
                            st.image(design_response, caption=f"DESIGN RENDER {i + 1:02d}", use_column_width=True)
